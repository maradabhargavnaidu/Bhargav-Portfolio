    ...
    <>
      <div className="bg-neutral-950 scroll-smooth pt-10" id="Home">
        <div className="container mx-auto py-20 space-y-5 md:px-20 px-5 ">
          <p className="relative z-10 text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 font-varela  font-normal">
            G&apos;day,
          </p>
          <p className="relative z-10 text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-yellow-200 to-yellow-700 font-varela font-bold">
            <span className="relative z-10 text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600 font-varela font-normal">
              I&apos;m
            </span>{" "}
            Bhargav
          </p>
          ...
          <div className="md:text-5xl space-x-5 py-5 pb-10 text-4xl">
          ...
          <a
            ...
            className="text-4xl relative z-10 bg-gradient-to-b from-yellow-200 to-yellow-700 font-varela py-3 font-semibold text-neutral-900 px-5 rounded-lg text- tral-50"
            target="_blank"
          >
            My Resume
          </a>
