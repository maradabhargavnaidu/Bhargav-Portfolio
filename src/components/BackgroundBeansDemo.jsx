...
export function BackgroundBeamsDemo() {
  return (
    <>
      <div className="bg-neutral-950 font-varela scroll-smooth pt-10" id="Home">
        <div className="container mx-auto py-20 space-y-5 px-5 ">
          <p className="relative z-10 text-4xl md:text-6xl bg-clip-text text-transparent bg-white font-varela  font-normal">
            G&apos;day,
          </p>
          {/* <p className="relative z-10 text-4xl md:text-6xl text-white font-varela  font-normal">
            G&apos;day,
          </p> */}
          <p className="relative z-10 text-4xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-b from-yellow-200 to-yellow-400 font-varela font-bold">
            <span className="relative z-10 text-4xl md:text-6xl bg-clip-text text-transparent bg-white font-varela font-normal">
              I&apos;m
            </span>{" "}
            Bhargav
          </p>
